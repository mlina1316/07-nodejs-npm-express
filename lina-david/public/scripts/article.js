...
Article.prototype.insertRecord = function(callback) {
  $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
    .then(data => {
      ...
      // The purpose of the line is to look for an parameter passed into insertRecord and turn the argument into a function. The callback is only invoked if something is passed into the insertRecord function. It is not because there was nothing passed into it.
